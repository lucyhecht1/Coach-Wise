window.onload = function() {
    var canvas = document.getElementById('courtCanvasInbound');
    ...
    var drawModeCheckbox = document.getElementById('drawModeInbound');
    var eraseModeCheckbox = document.getElementById('eraseModeInbound');  // New checkbox for erase mode

    // Load the basketball court image
    var courtImage = new Image();
    courtImage.src = '/static/halfcourt.jpg';
    ...
    // Player positions
    var players = [
        { x: 360, y: 30, color: 'blue' },
        { x: 333, y: 100, color: 'red' },
        { x: 333, y: 125, color: 'green' },
        { x: 333, y: 150, color: 'yellow' },
        { x: 333, y: 175, color: 'purple' }
    ];
